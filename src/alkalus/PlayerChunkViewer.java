...
public class PlayerChunkViewer extends JFrame {
	...
	public class TicketInfoDialog extends JDialog implements LayoutManager {
		...
		public TicketInfoDialog(LinkedList<TicketInfo> tickets) {
			...
			chunkScrollPane = new JScrollPane(chunkPane, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
		...
		public void update() {
			...
			if (ticket.entity != null)
				info += "<br>Entity: " + EntityList.classToStringMapping.get(ticket.entity) + "#"
						+ ticket.entity.getEntityId() + " (" + String.format("%.2f", ticket.entity.posX) + ", "
						+ String.format("%.2f", ticket.entity.posY) + ", " + String.format("%.2f", ticket.entity.posZ)
						+ ")";
	...
	public class DisplayArea extends JPanel implements MouseListener, MouseMotionListener {
		...
		public void mouseDragged(MouseEvent event) {
			setCenter((mouseClickedX - event.getX()) * 4 + centerClickedX,
